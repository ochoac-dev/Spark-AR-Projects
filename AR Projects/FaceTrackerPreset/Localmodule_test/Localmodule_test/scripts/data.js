...
(async funtion(){
 ...
 const[plane,material] = away Promise.all([
 
 Scene.root.findFirst('Color'),
    
    Materials.findFrist('Color2'),


 ])});

material.diffuse = texture;
findUsingPattern(EN: string, config?: {limit: 10}): Promise<Array<TextureBase>>
